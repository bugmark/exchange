class Amendment::Transfer < Amendment
  ...
  belongs_to :sell_offer      , class_name: "Offer"   , :optional => true, :foreign_key => :trn_sell_offer_id
  belongs_to :buy_offer       , class_name: "Offer"   , :optional => true, :foreign_key => :trn_buy_offer_id
  belongs_to :parent_position , class_name: "Position", :optional => true, :foreign_key => :trn_parent_position_id
  belongs_to :seller_position , class_name: "Position", :optional => true, :foreign_key => :trn_seller_position_id
  belongs_to :buyer_position  , class_name: "Position", :optional => true, :foreign_key => :trn_buyer_position_id
