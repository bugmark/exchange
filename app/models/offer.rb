...
class Offer < ApplicationRecord
  ...
  VALID_STATUS     = %w[open suspended crossed expired canceled].freeze
  ...
  class << self
    ...
    alias by_range by_maturation_range
    ...
    def select_subset
      select(%i[id uuid type user_uuid prototype_uuid volume price value poolable aon status stm_issue_uuid stm_status])
    end
  ...
  alias has_counters? has_qualified_counteroffers?
  ...
  alias funder_cost unfixed_cost
  ...
  def update_value
    self.value = if self.price && self.volume
