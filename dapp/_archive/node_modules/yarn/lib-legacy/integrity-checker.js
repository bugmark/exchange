...
class InstallationIntegrityChecker {
  ...
  check(patterns, lockfile, flags) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      const actual = yield _this4._generateIntegrityFile(lockfile, patterns, (0, (_assign || _load_assign()).default)({}, { checkFiles: false }, flags), // don't generate files when checking, we check the files below
      loc.locationFolder);
